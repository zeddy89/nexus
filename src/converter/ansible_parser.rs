...
pub struct AnsibleTask {
    ...
    pub with_together: Option<serde_yaml::Value>,
    pub with_nested: Option<serde_yaml::Value>,
    pub with_sequence: Option<serde_yaml::Value>,
    pub with_fileglob: Option<serde_yaml::Value>,
    pub with_subelements: Option<serde_yaml::Value>,
    pub loop_control: Option<HashMap<String, serde_yaml::Value>>,
    pub r#async: Option<u64>,
    pub poll: Option<u64>,
